...
class SolutionInstance(Base):
    ...
    profile_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("hardening_profiles.id", ondelete="SET NULL"), nullable=True)
    ...
    profile: Mapped["HardeningProfile"] = relationship("HardeningProfile")
